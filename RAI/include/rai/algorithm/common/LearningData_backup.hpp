...
#ifndef RAI_LearningData0_HPP
#define RAI_LearningData0_HPP
...
class LearningData0 {
 ...
 public:
  ...
  LearningData0(TrajAcquisitor_ *acq) : trajAcquisitor_(acq),stateTensor("state"),
                                       actionTensor("sampled_oa"),
                                       actionNoiseTensor("noise_oa"),trajLength("length"){
  }
  LearningData0(TupleAcquisitor_ *acq) : tupleAcquisitor_(acq) {}
